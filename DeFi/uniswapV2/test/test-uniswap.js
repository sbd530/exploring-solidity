const BN = require("bn.js"); //* js용 BigNumber
...
contract("TestUniswap", (accounts) => {
    ...
    const AMOUNT_IN = new BN(10).pow(new BN(18)).mul(new BN(1_000_000)); // 1,000,000 DAI
    ...
    it("should swap", async () => {
        ...
        const testUniswap = await TestUniswap.new(); //* deploy
